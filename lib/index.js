 ...
 * @param options
 * 
 * @returns {Promise<[Object]>} this.migrate - Performs database migration
 * @throws {Exception} this._handle - Handles error throughout application
 * 
 */
class Migrate extends Run {
   ...
   * @throws {Error} prints and throws an error if error occurs
   * 
   */
  _handle(err) {
